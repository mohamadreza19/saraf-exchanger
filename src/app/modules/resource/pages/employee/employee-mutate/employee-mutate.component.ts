...
@Component({
  selector: 'app-employee-mutate',
  standalone: true,
  imports: [FormBuilder2Component, HeaderButtonsComponent],
  templateUrl: './employee-mutate.component.html',
  styleUrl: './employee-mutate.component.css',
})
export class EmployeeMutateComponent {
  ...
  initForms() {
    ...
    this.forms = [form1, form2, form3, form4];
